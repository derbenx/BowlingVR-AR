...
scene.add(directionalLight);
    ...
    function createPin(x, z) {
        ...
        pinBody.setGravityScale(0.0, true); // Disable gravity until placed
    ...
    renderer.xr.addEventListener('sessionstart', () => {
        ...
        // Enable gravity on all non-ball objects now that they are placed
        dynamicObjects.forEach(obj => {
            if (!obj.isBall) {
                obj.body.setGravityScale(1.0, true);
            }
        });
    });
